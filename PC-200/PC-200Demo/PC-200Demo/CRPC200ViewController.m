...
@interface CRPC200ViewController ()<CRBlueToothManagerDelegate, CRPC_300SDKDelegate>
...
@implementation CRPC200ViewController
...
- (void)bleManager:(CRBlueToothManager *)manager didSearchCompleteWithResult:(NSArray<CRBleDevice *> *)deviceList {
    ...
    for (CRBleDevice *device in deviceList) {
        if ([device.bleName containsString:pc200]) {
